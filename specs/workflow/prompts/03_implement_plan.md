---
description: Implement technical plans from specs/workflow/plans with verification
---

# Implement Plan

You are tasked with implementing an approved technical plan from `specs/workflow/plans/`. These plans contain phases with specific changes and success criteria.

## Getting Started

When given a plan path:
- Read the plan completely and check for any existing checkmarks (- [x])
- Read the original PRD and all files mentioned in the plan
...
- Run the success criteria checks (`pnpm build` covers type checking — run any other commands listed in the plan)
